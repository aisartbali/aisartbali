...
const animatedElements = document.querySelectorAll('.img-hover, .line, .custom-line, .custom-line2, .sculpture-content, .gallery-img, .gallery-img, .Shipping-gallery, .features, .feature-item, .highlight-banner, .Shipping-galery2, .shipping-intro-h, .contact-logo, .animate-text-contact, .animate-text');
